...
import { deepCopy, pick } from "../core/utils/objects";
// import { ControlPanel } from "../search/control_panel/control_panel";
// import { extractLayoutComponents } from "../search/layout";
...
export class View extends Component {
    ...
    async loadView(props) {
        ...
        let viewDescription = { viewId, resModel, type, arch, actionMenus};
