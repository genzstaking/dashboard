...
import { status, useComponent, useEffect, useRef, onWillUnmount, useEnv} from "@odoo/owl";
 ...
 */
export function useAutofocus({ refName, selectAll }: { refName?: string, selectAll?: any }) {
